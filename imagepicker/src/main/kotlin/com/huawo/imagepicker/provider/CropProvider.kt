package com.huawo.imagepicker.provider
...
import com.huawo.imagecrop.UCrop
import com.huawo.imagepicker.ImagePicker
import com.huawo.imagepicker.ImagePickerActivity
import com.huawo.imagepicker.R
import com.huawo.imagepicker.util.FileUtil
import java.io.File
...
class CropProvider(activity: ImagePickerActivity) : BaseProvider(activity) {
    ...
    private val mFixedWidth: Int
    private val mFixedHeight: Int
    ...
    init {
        ...
        mFixedWidth = bundle.getInt(ImagePicker.EXTRA_FIXED_WIDTH, 0)
        mFixedHeight = bundle.getInt(ImagePicker.EXTRA_FIXED_HEIGHT, 0)
        mCornerRadius = bundle.getInt(ImagePicker.EXTRA_CORNER_RADIUS, 0)
    ...
    private fun cropImage(uri: Uri) {
        ...
        if (mFixedWidth > 0 && mFixedHeight > 0) {
            uCrop.withFixedSize(mFixedWidth, mFixedHeight, mCornerRadius)
        } else {
