...
import com.huawo.imagepicker.util.ExifDataCopier
import com.huawo.imagepicker.util.FileUtil
import com.huawo.imagepicker.util.ImageUtil
import java.io.File
        ...
        object : AsyncTask<Uri, Void, File>() {
            ...
            override fun onPostExecute(file: File?) {
                ...
                if (file != null) {
                    ...
                    // Post Error
                    setError(com.huawo.imagepicker.R.string.error_failed_to_compress_image)
                }
            }
        }.execute(uri)
    }
