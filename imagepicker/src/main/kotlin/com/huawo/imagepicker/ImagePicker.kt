package com.huawo.imagepicker

import android.app.Activity
import android.content.Intent
import android.os.Bundle
import androidx.fragment.app.Fragment
import com.huawo.imagepicker.constant.ImageProvider
import com.huawo.imagepicker.listener.DismissListener
import com.huawo.imagepicker.listener.ResultListener
import com.huawo.imagepicker.util.DialogHelper
import java.io.File
...
open class ImagePicker {
    ...
    companion object {
        ...
        internal const val EXTRA_FIXED_WIDTH = "extra.fixed_width"
        internal const val EXTRA_FIXED_HEIGHT = "extra.fixed_height"
        internal const val EXTRA_CORNER_RADIUS = "extra.corner_radius"
    ...
    class Builder(private val activity: Activity) {
        ...
        private var fixedCornerRadius: Int = 0
        ...
        fun fixedResultSize(width: Int, height: Int, cornerRadius: Int): Builder {
            this.fixedWidth = width
            this.fixedHeight = height
            this.fixedCornerRadius = cornerRadius
            return this;
        }
        ...
        private fun getBundle(): Bundle {
            return Bundle().apply {
                ...
                putInt(EXTRA_FIXED_WIDTH, fixedWidth)
                putInt(EXTRA_FIXED_HEIGHT, fixedHeight)
                putInt(EXTRA_CORNER_RADIUS, fixedCornerRadius)
