package com.huawo.imagecrop.view;
...
import com.huawo.imagecrop.R;
import com.huawo.imagecrop.callback.BitmapCropCallback;
import com.huawo.imagecrop.callback.CropBoundsChangeListener;
import com.huawo.imagecrop.model.CropParameters;
import com.huawo.imagecrop.model.ImageState;
import com.huawo.imagecrop.task.BitmapCropTask;
import com.huawo.imagecrop.util.CubicEasing;
import com.huawo.imagecrop.util.RectUtils;
...
public class CropImageView extends TransformImageView {
    ...
    private float mTargetCornerRadiusRatio;
    ...
    private int mFixedResultImageSizeX = 0, mFixedResultImageSizeY = 0, mFixedCornerRadius = 0;
    ...
    public void cropAndSaveImage(@NonNull Bitmap.CompressFormat compressFormat, int compressQuality,
        ...
        final CropParameters cropParameters = buildCropParameters(compressFormat, compressQuality);
    ...
    private CropParameters buildCropParameters(@NonNull Bitmap.CompressFormat compressFormat, int compressQuality) {
        if (mFixedResultImageSizeX > 0 && mFixedResultImageSizeY > 0) {
            return new CropParameters(
                    mFixedResultImageSizeX, mFixedResultImageSizeY, mFixedCornerRadius,
     ...
     */
    public void setCropRect(RectF cropRect, float cornerRadius) {
     ...
     */
    public void setTargetAspectRatio(float targetAspectRatio, float cornerRadiusRatio) {
        mTargetCornerRadiusRatio = cornerRadiusRatio;
        ...
        if (mCropBoundsChangeListener != null) {
            mCropBoundsChangeListener.onCropAspectRatioChanged(mTargetAspectRatio, mTargetCornerRadiusRatio);
        }
    }
    ...
    public void setFixedResultImageSize(@IntRange(from = 10) int fixedResultImageSizeX, @IntRange(from = 10) int fixedResultImageSizeY, int fixedCornerRadius) {
        mFixedResultImageSizeX = fixedResultImageSizeX;
        mFixedResultImageSizeY = fixedResultImageSizeY;
        mFixedCornerRadius = fixedCornerRadius;
    }
    ...
    protected void onImageLaidOut() {
        ...
        mCornerRadius = mThisWidth * mTargetCornerRadiusRatio;
