...
import com.huawo.imagecrop.callback.OverlayViewChangeListener;
...
public class OverlayView extends View {
    ...
    private Path mWithCornerRadiusPath = new Path();
     ...
     */
    public void setTargetAspectRatio(final float targetAspectRatio, final float cornerRadiusRatio) {
    ...
    public void setupCropBounds() {
        ...
        if (mCallback != null) {
            mCallback.onCropRectUpdated(mCropViewRect, mCornerRadius);
        }
    ...
    private void updateGridPoints() {
        ...
        mWithCornerRadiusPath.reset();
        mWithCornerRadiusPath.addRoundRect(mCropViewRect, mCornerRadius, mCornerRadius, Path.Direction.CW);
    }
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if (changed) {
            ...
            if (mShouldSetupCropBounds) {
                ...
                setTargetAspectRatio(mTargetAspectRatio, mTargetCornerRadiusRatio);
            }
        }
    }
...
//        }
    ...
    protected void drawDimmedLayer(@NonNull Canvas canvas) {
        canvas.save();
        if (mCornerRadius > 0) {
            canvas.clipPath(mWithCornerRadiusPath, Region.Op.DIFFERENCE);
