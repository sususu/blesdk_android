package com.huawo.imagecrop.task;
...
import com.huawo.imagecrop.util.BitmapLoadUtils;
import com.huawo.imagecrop.util.FileUtils;
import com.huawo.imagecrop.util.ImageHeaderParser;
...
public class BitmapCropTask extends AsyncTask<Void, Void, Throwable> {
    ...
    private final int mFixedResultImageSizeX, mFixedResultImageSizeY, mFixedCornerRadius;
    ...
    public BitmapCropTask(@NonNull Context context, @Nullable Bitmap viewBitmap, @NonNull ImageState imageState, @NonNull CropParameters cropParameters,
        ...
        mFixedResultImageSizeX = cropParameters.getFixedResultImageSizeX();
        mFixedResultImageSizeY = cropParameters.getFixedResultImageSizeY();
        mFixedCornerRadius = cropParameters.getFixedCornerRadius();
