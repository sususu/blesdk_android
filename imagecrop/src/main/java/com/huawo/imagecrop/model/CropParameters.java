package com.huawo.imagecrop.model;
...
public class CropParameters {
    ...
    private int mFixedResultImageSizeX, mFixedResultImageSizeY, mFixedCornerRadius;
    ...
    public CropParameters(int fixedResultImageSizeX, int fixedResultImageSizeY, int fixedCornerRadius,
                          Bitmap.CompressFormat compressFormat, int compressQuality,
                          String imageInputPath, String imageOutputPath, ExifInfo exifInfo) {
    ...
    public int getFixedResultImageSizeX() {
        return mFixedResultImageSizeX;
    }

    public int getFixedResultImageSizeY() {
        return mFixedResultImageSizeY;
    }

    public int getFixedCornerRadius() {
        return mFixedCornerRadius;
    }
