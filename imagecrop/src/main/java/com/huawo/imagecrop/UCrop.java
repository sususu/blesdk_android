...
public class UCrop {
    ...
    private static final String EXTRA_PREFIX = "com.huawo.imagecrop";
    ...
    public static final String EXTRA_FIXED_SIZE_X = EXTRA_PREFIX + ".FixedSizeX";
    public static final String EXTRA_FIXED_SIZE_Y = EXTRA_PREFIX + ".FixedSizeY";
    public static final String EXTRA_CORNER_RADIUS = EXTRA_PREFIX + ".CornerRadius";
    ...
    public UCrop withFixedSize(@IntRange(from = MIN_SIZE) int width, @IntRange(from = MIN_SIZE) int height, int cornerRadius) {
        if (width < MIN_SIZE) {
            width = MIN_SIZE;
        }
        ...
        mCropOptionsBundle.putInt(EXTRA_FIXED_SIZE_X, width);
        mCropOptionsBundle.putInt(EXTRA_FIXED_SIZE_Y, height);
        mCropOptionsBundle.putInt(EXTRA_CORNER_RADIUS, cornerRadius);
        return this;
    }
